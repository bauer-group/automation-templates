...
[![🔄 CI/CD Pipeline (Automatic Release)](https://github.com/bauer-group/automation-templates/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/bauer-group/automation-templates/actions/workflows/ci-cd.yml)
