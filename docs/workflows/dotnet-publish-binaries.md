...
| `DOTNET_NUGET_RESTORE_CREDENTIALS` | `nuget-source-name` is set | PAT (`read:packages`) for restoring from a private feed - see [Private NuGet Feeds](#private-nuget-feeds). |
