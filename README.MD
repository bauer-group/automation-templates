...
<!-- Generated on 2026-09-02 18:09:52 UTC -->
...
│   │   ├── dotnet-nuget-auth/    # Authenticated restore from private NuGet feeds
│   │   ├── dotnet-msi/           # WiX MSI packaging for Windows deployment
...
│       ├── dotnet-package-msi.yml    # .NET MSI packaging (WiX)
...
│           ├── dotnet-package-msi/  # .NET MSI packaging examples
...
| **🟢 .NET MSI Package** | Available | Per-machine Windows Installer packaging with WiX | `uses: bauer-group/automation-templates/.github/workflows/dotnet-package-msi.yml@main` |
...
**.github/config/commitlint.config.mjs**
...
4. **Customize configuration:**
   ...
   vim .github/config/commitlint.config.mjs
   ```
...
- [📦 **Semantic Release Config Contract**](docs/workflows/semantic-release-config.md) - What a repository's `semantic-release.json` actually controls, and what is silently ignored
...
- [🪟 **.NET MSI Packaging**](docs/workflows/dotnet-package-msi.md) - Per-machine Windows Installer packaging with WiX
...
- [🧠 **AI Issue Summary**](docs/workflows/ai-issue-summary.md) - Copilot-powered issue and PR summaries
...
- [🔐 **GHCR Internal Visibility**](docs/ghcr-internal-visibility.md) - Registry authentication for internal/private container packages

#### 🔍 Validation Modules

- [🔍 **Docker Base Image Monitor**](docs/workflows/modules-docker-base-image-monitor.md) - Base image digest drift detection
...
- [🔐 **dotnet-nuget-auth**](.github/actions/dotnet-nuget-auth/action.yml) - Authenticated restore from private NuGet feeds
- [🪟 **dotnet-msi**](.github/actions/dotnet-msi/action.yml) - WiX MSI packaging for Windows deployment
...
- [🪟 **.NET MSI Examples**](github/workflows/examples/dotnet-package-msi/) - .NET MSI packaging examples
...
*Generated on 2026-09-02 18:09:52 UTC from [docs/README.template.MD](docs/README.template.MD)*
